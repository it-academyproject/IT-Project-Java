...
public class EmailService
{
			...
			if (counter == 8)
			{
				...
				if (hasBeenNotified == false)
				{
					...
					String messageBody = "I hope this e-mail finds you well. This message is to inform you, that you have."
							+ counter + " absences in the IT Academy course.";
		...
		for (int i = 0; i < finishInXDays.size(); i++)
		{
			if (finishInXDays.get(i).getEndDate() != null)
			{
				...
				if (daysInt == 15)
				{
					...
					String messageBody = "I hope this e-mail finds you well. This message is to inform you, "
							+ "that you are about to end the IT Academy course in less than " + daysInt + " days.";
					if (email != null && name != null)
					{
						try
						{
	...
	public void emailNotification(String email, String name, String messageBody) throws Exception
	{
		...
		helper.setTo(email);
		helper.addBcc("barcelonaactiva.itacademy@gmail.com"); 
		helper.setSubject("Barcelona Activa - IT Academy Program");
		String arg0 = new String(
				"<body class=\"respond\" leftmargin=\"0\" topmargin=\"0\" marginwidth=\"0\" marginheight=\"0\">"
						+ "    <!-- pre-header -->" + "    <table style=\"display:none!important;\">" + "        <tr>"
						+ "            <td>"
						...
						+ "                    Welcome to Barcelona Activa!" + "                </div>"
						+ "            </td>" + "        </tr>" + "    </table>" + "    <!-- pre-header end -->"
						+ "    <!-- header -->"
