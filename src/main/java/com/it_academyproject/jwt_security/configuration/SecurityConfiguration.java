...
//                .antMatchers("/api/public/**" , "/api/get-reset-email/**" , "/api/save-new-password/**");
    ...
    //B-17 task. Add to web.ignoring controllers used during development to avoid asking for a Token during dev
    	...
    	web.ignoring()
        .antMatchers("/api/test/**","/api/public/**" , "/api/get-reset-email/**" , "/api/save-new-password/**" , "/api/students/**" , "/api/stats/**" , "/api/exercises/**", "/api/exercises/student/**", "/api/iterations/**", "/api/projects/**", "/api/itineraries/**", "/api/useriteration/**", "/api/projectitinerary/**", "/api/absences/**", "/api/absences/student/**", "/api/preferences/**");
