...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter
{
	...
	public void configure(WebSecurity web) throws Exception
	{
		...
		// web.ignoring().antMatchers("/api/public/**", "/api/get-reset-email/**", "/api/save-new-password/**");
		...
		web.ignoring().antMatchers("/api/test/**", "/api/public/**", "/api/get-reset-email/**",
				"/api/save-new-password/**", "/api/students/**", "/api/statistics/**", "/api/exercises/**",
				"/api/exercises/student/**", "/api/iterations/**", "/api/projects/**", "/api/itineraries/**",
				"/api/useriteration/**", "/api/projectitinerary/**", "/api/absences/**", "/api/absences/student/**");
	}
